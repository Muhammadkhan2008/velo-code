...
export const EXTENSION_CATALOG: ExtensionCatalogEntry[] = [
  ...
  { id: 'runner-java', name: 'Java Runner', description: 'Compile/run Java via server runtime when available.', category: 'runner', downloadPath: '/extensions/runner-java.js', runnerMode: 'server', languages: ['java', 'kotlin'] },
  { id: 'runner-cpp', name: 'C/C++ Runner', description: 'Compile/run C and C++ via server runtime.', category: 'runner', downloadPath: '/extensions/runner-cpp.js', runnerMode: 'server', languages: ['c', 'cpp', 'objective-c'] },
  { id: 'runner-go', name: 'Go Runner', description: 'Execute Go code via server runtime.', category: 'runner', downloadPath: '/extensions/runner-go.js', runnerMode: 'server', languages: ['go'] },
  { id: 'runner-rust', name: 'Rust Runner', description: 'Compile/run Rust via server runtime.', category: 'runner', downloadPath: '/extensions/runner-rust.js', runnerMode: 'server', languages: ['rust'] },
  ...
  { id: 'runner-php', name: 'PHP Runner', description: 'Execute PHP via server runtime.', category: 'runner', downloadPath: '/extensions/runner-php.js', runnerMode: 'server', languages: ['php'] },
  { id: 'runner-ruby', name: 'Ruby Runner', description: 'Execute Ruby via server runtime.', category: 'runner', downloadPath: '/extensions/runner-ruby.js', runnerMode: 'server', languages: ['ruby', 'perl'] },
